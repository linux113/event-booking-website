...
--
-- The whole schema in one statement batch: 26 sections, wrapped in a
...
-- ===========================================================================
-- 20260925100000_admin_delete_event_date.sql
-- ===========================================================================
...
-- ===========================================================================
-- 20260925110000_database_gallery_images.sql
-- ===========================================================================
...
-- ===========================================================================
-- 20260925120000_booking_referral_name.sql
-- ===========================================================================
...
insert into setup.applied_migrations (filename, checksum) values
  ...
  ('20260925100000_admin_delete_event_date.sql', 'da1643226ce8ea625ed2339e17df1fdd7a21dc36b638263e31e17da371a22a94'),
  ('20260925110000_database_gallery_images.sql', '2ab6db1198ce695245aa8f87cb40ca5e4fb868acfb1a9be4cee2aa135343d38c'),
  ('20260925120000_booking_referral_name.sql', '1b87cde6153b95826976666c303d1b2174b54f159f18d0ca143945776efc85d7'),
  ('20260925130000_booking_check_in_times_text.sql', 'fcb4ef8172361f47d5cdfe22003a3c3233594678bac38716d5a2f2020a188f66'),
